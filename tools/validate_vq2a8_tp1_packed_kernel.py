...
def _run_projection(
    ...
    *,
    ...
    result = {
        ...
        "packed_projection_backend": "triton_native_e4m3_auto_cv_dot_v6",
        "ascend_compile_profile": ("standard_fp8_matmul_dynamic_cv_defaults" if device.type == "npu" else None),
        "native_fp8_dot": True,
