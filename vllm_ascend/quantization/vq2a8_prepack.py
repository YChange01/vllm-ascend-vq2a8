...
from .vq2a8_artifact_io import _publish_directory, _sha256, _sync_directory, _sync_file, _write_json


def _cpu_modules():
    from . import vq2a8_runtime, vq2a8_v4_v2_layout, vq2a8_v4_v2_prepacked

    return vq2a8_runtime, vq2a8_v4_v2_layout, vq2a8_v4_v2_prepacked
...
def run(args):
    ...
    try:
        ...
        manifest = {
            ...
            "layers": layers,
            "producer": {
                "tool": "vllm_ascend.quantization.vq2a8_prepack",
