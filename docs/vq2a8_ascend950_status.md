...
**Current v0.23 branch:** see [the v0.23 migration guide](vq2a8_v023_migration.md).
Historical results below do not certify the newly migrated branch on NPU.

**Historical 0.26 migration (2026-09-08):** see [the migration guide](vq2a8_v026_migration.md)
for the new branch, matched dependencies, rebuild commands and remaining
hardware gates. Historical PASS results below do not certify the 0.26 stack.
