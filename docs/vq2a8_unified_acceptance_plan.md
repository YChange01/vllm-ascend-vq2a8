...
```bash
python -u tools/accept_vq2a8_release.py --model /home/g00872988/vq2a8 --library build/vq2a8-ascendc-v023/libvq2a8_ascendc.so --physical-npu 0
```
...
```bash
python -u tools/accept_vq2a8_release.py --model /home/g00872988/vq2a8 --library build/vq2a8-ascendc-v023/libvq2a8_ascendc.so --physical-npu 0 --resume 报告目录
```
