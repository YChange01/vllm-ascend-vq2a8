...
> Historical record for the separate `ascend950-vq2a8-v026` branch.
> Do not use its installation commands or validation results for this v0.23
> branch. Use [the v0.23 migration guide](vq2a8_v023_migration.md) instead.
